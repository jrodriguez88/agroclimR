...
#'   \item{LAI_OBS}{Leaf Area Index observed - (\code{numeric}). Measures the area of leaves per unit area of ground, in m2 leaf/m2 ground.}
#'   \item{LAI_SE}{Leaf Area Index standard deviation - (\code{numeric}). The standard deviation of the Leaf Area Index, in m2 leaf/m2 ground.}
...
#'   \item{NLV_OBS}{Number of green leaves - (\code{numeric}). The number of green leaves per square meter, in number/m2.}
#'   \item{NLV_SE}{Number of green leaves standard error - (\code{numeric}). The standard error of the number of green leaves, in number/m2.}
#'   \item{NST_OBS}{Number of stems - (\code{numeric}). The number of stems per square meter, in number/m2.}
#'   \item{NST_SE}{Number of stems standard error - (\code{numeric}). The standard error of the number of stems, in number/m2.}
#'   \item{NP_OBS}{Number of panicles - (\code{numeric}). The number of panicles per square meter, in number/m2.}
#'   \item{NP_SE}{Number of panicles standard error - (\code{numeric}). The standard error of the number of panicles, in number/m2.}
#' }
