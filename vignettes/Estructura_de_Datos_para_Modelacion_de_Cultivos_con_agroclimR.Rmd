...
Un resultado similar podemos obtener si exportamos los dtos desde el libreo de trabajo propuesto en agroclimR
...
obs_data2 = list(read_agroclimr_data(path_file))
